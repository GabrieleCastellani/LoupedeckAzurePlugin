namespace Loupedeck.LoupedeckAzurePlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.LoupedeckAzurePlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.LoupedeckAzurePlugin.Resources.Resource.txt`.
